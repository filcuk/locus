...
export const catalogue = {
  ...
  'entry.detail.tags': 'Tags',
  'entry.detail.tagsEmpty': 'No tags yet.',
  ...
  'collection.detail.edit': 'Edit',
  'collection.detail.editTitle': 'Title',
  'collection.detail.editPlaceholder': 'Collection name',
  'collection.detail.save': 'Save',
  'collection.detail.cancel': 'Cancel',
  'collection.detail.delete': 'Delete collection',
  'collection.detail.deleteConfirm': 'Delete this collection?',
  'collection.detail.deleteAction': 'Delete',
  'collection.detail.deleteCancel': 'Keep',
  'collection.detail.editError': 'Enter a title.',
  ...
  'settings.tags': 'Tags',
  'settings.tags.intro':
    'System tags are shared. Your private tags stay in your catalogue; chips on shared entries can still show others’ applied tags without letting you reuse them.',
  'settings.tags.private': 'Your private tags',
  'settings.tags.privateEmpty': 'No private tags yet.',
  'settings.tags.system': 'System tags',
  'settings.tags.systemEmpty': 'System tags appear after sync.',
  'settings.tags.create': 'Create a private tag',
  'settings.tags.labelPlaceholder': 'Label',
  'settings.tags.colourPlaceholder': 'Colour (#rrggbb)',
  'settings.tags.createAction': 'Add tag',
  'settings.tags.retire': 'Retire',
  'settings.tags.retireStrip': 'Retire and strip',
  'settings.tags.retired': 'retired',
