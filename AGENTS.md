...
| `.cursor/rules/` | Enforced guardrails, one concern per file: doc structure, design adherence, decisions, git workflow, security, privacy, licensing, attribution, assets, code quality, testing, i18n, API/data, offline-first client, native dependencies | Long-form specification |
...
8. Next up when asked to implement: the P0 scaffold.

`.cursor/rules/git-workflow.mdc` is the enforced version of points 5–7, with the `gh stack` commands.
